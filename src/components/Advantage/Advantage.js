          ...
          <div className="col-3">
            <div className="row">
              ...
              <label className="des-advantage">
                Bạn có thể chọn từ hàng ngàn biệt thự và căn hộ trên khắp thế
                giới. Không bao giờ hết lựa chọn!
              </label>
            </div>
          </div>
          <div className="col-3">
            <div className="row">
              ...
              <label className="des-advantage">
                Bạn lo lắng liệu có phòng khi đặt chỗ? Chúng tôi đảm bảo bạn sẽ
                được ở tại nơi lưu trú bạn đã đặt.
              </label>
            </div>
          </div>
          <div className="col-3">
            <div className="row">
              ...
              <label className="des-advantage">
                Bạn có thể chọn từ nhiều phương thức thanh toán khác nhau, bằng
        ...
        <div className="row justify-content-md-center">
          <div className="col-3">
            <div className="row">
              ...
              <label className="des-advantage">
                Muốn nghỉ cùng gia đình hoặc vui vẻ với bạn bè? Bạn có thể thuê
                toàn bộ căn hộ hoặc phòng riêng, tuỳ vào nhu cầu của bạn.
              </label>
            </div>
          </div>
          <div className="col-3">
            <div className="row">
              ...
              <label className="des-advantage">
                Hãy liên hệ với chúng tôi qua điện thoại, ứng dụng Traveloka
                hoặc email. Bộ phận Hỗ trợ Khách hàng chuyên nghiệp luôn sẵn
                sàng giúp đỡ bạn 24/7.
              </label>
            </div>
          </div>
        </div>
